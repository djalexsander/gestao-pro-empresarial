  ...
  async function handleExportCSV() {
    ...
    await exportarBlocoCSV(
      ...
      [
        ...
        { header: "Produto", get: (r) => r.Produto },
        { header: "SKU", get: (r) => r.SKU },
        { header: "Quantidade", get: (r) => r.Quantidade, type: "number" },
        { header: "Total vendido", get: (r) => r["Total vendido"], type: "currency" },
        { header: "Custo total", get: (r) => r["Custo total"], type: "currency" },
        { header: "Lucro bruto", get: (r) => r["Lucro bruto"], type: "currency" },
        { header: "Vendas", get: (r) => r.Vendas },
      ],
