...
BEGIN
  ...
  -- ============ Validação de estoque (atômica) ============
  -- Soma a quantidade pedida por produto e compara com o saldo atual.
  -- Bloqueia a venda inteira se qualquer produto não tiver saldo suficiente.
  FOR v_check IN
